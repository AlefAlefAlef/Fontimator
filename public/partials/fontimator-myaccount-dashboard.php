...
<div class="fontimator-myaccount-dashboard">
	...
	<?php if ( 'alefalefalef' === FTM_SITE_NAME ) { ?>
		...
		<div class="tables">
			<div class="dashbox dashbox-full">
				<?php 
				$did_you_know = array(
					"המשמעות הקדומה של האות אָלֶף היא שור, וצורתה התפתחה מצורת ראש השור.",
					"בעברית המודרנית שכיחות השימוש באות אל״ף היא 4.94% מבין כלל אותיות האלפבית.",
					"לפי תורת הקבלה: מי ששמם מתחיל באל״ף הם טיפוסים של חידושים, הפתעות ומהפכים. מי שאחת האותיות האמצעיות בשמו היא אל״ף הם טיפוסים מלאי רגש, חביבות ואכפתיות לזולת. מי ששמם מסתיים באל״ף הם טיפוסים בעלי חוש הומור ואינטליגנציה גבוהה.",
					"האות צ׳ נקראת צדי ולא צדיק. הטעות השתרשה כתוצאה מהסמיכות שלה לאות קוף שבאה אחריה.",
					"בצרפת ובפינלנד משתמשים בביטוי ״זה כמו עברית בשבילי״ כדי להמחיש עד כמה דבר אינו מובן להם, בדומה לאופן שבישראל משתמשים בביטוי ״זה כמו סינית בשבילי״.",
					"עברית היא השפה היחידה בעולם ששימשה כשפה מדוברת, נעלמה, ואחרי מאות שנים חזרה להיות שפה מדוברת.",
					"ספר התנ״ך הוא הספר המתורגם ביותר בהיסטוריה. ניתן למצוא אותו ב-2,454 שפות שונות. במקום השני: פינוקיו.",
					"בראשית דרכה של העברית היא נכתבה בצורת החריש – מימין לשמאל, ובשורה הבאה- משמאל לימין.",
					"בעת העתיקה היו שתי דרכים לסדר האלפבית העברי: האחת זו שמוכרת לנו כיום, והשניה היא זו שבה האות פ׳ קודמת לאות ע׳.",
					"בעבר, האותיות הסופיות שימשו גם כאותיות רגילות ונכתבו גם באמצע המילה וגם בסופה. עם השנים, תחתיות האותיות התעגלו שמאלה לצורה שבה אנו מכירים כיום באמצע מילה. ",
				);
				?>
				<h4>הידעת?</h4> 
				<p><?php echo $did_you_know[array_rand($did_you_know)]; ?></p>
			</div>
		</div>
	<?php } ?>
	<?php
